...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Administrator Administrator | Ihsao</title>
                ...
                <div class="content">
                  <?php require_once 'include/topbar.php';?>
                    ...
                    <div class="container-fluid">
                        ...
                        <?php }?>
                        <a href="<?= base_url();?>admin/administrator/add"><button type="button" class="btn btn-secondary" style="margin-bottom: 10px;">Tambah Admin</button></a>
                        <div class="row">
                             <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url();?>admin/administrator/edit/<?= $admin['admin_username'];?>"><button type="button" class="btn btn-warning"><i class="mdi mdi-pencil"></i> </button></a>
                                                        <a href="<?= base_url();?>admin/administrator/delete/<?= $admin['admin_id'];?>"><button type="button" class="btn btn-danger"><i class="mdi mdi-trash-can"></i> </button></a></td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
                                        </table>

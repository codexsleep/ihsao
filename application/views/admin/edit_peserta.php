...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Edit Peserta Administrator | Ihsao</title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?= base_url();?>admin/quiz">Peserta</a></li>
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                        <div class="tab-content">
                                                <form class="needs-validation" method="POST" action="<?= base_url();?>admin/peserta/edit_process/<?= $peserta['peserta_id'];?>" novalidate>
                                                    <div class="mb-3">
                                                        <label class="form-label">Nama</label>
                                                        <input type="text" class="form-control" name="nama" placeholder="Masukkan nama peserta" value="<?= $peserta['peserta_name'];?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Email</label>
                                                        <input type="text" class="form-control" name="email" placeholder="Masukkan email peserta" value="<?= $peserta['peserta_email'];?>" required>
                                                    </div>
                                                     <div class="mb-3">
                                                        <label class="form-label">NIS</label>
                                                        <input type="text" class="form-control" name="nis" placeholder="Masukkan nis peserta" value="<?= $peserta['peserta_nis'];?>" required>
                                                    </div>

                                        ...
                                        <div class="tab-content">
                                                <form class="needs-validation" method="POST" action="<?= base_url();?>admin/quiz/edit_process/<?= $id;?>" novalidate>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="mt-2">
                                                            <div class="form-check form-check-inline">
                                                                <input type="radio" name="jenis" value="Objektif" class="form-check-input" required="" <?php if($quiz['quiz_type']=='Objektif'){ echo "checked";}?>>
                                                                <label class="form-check-label">Objektif</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input type="radio" name="jenis" value="Esay" class="form-check-input" required=""  <?php if($quiz['quiz_type']=='Esay'){ echo "checked";}?>>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Masukkan waktu pengerjaan quiz" name="waktu" value="<?= $quiz['quiz_time'];?>" required>
                                                    </div>
                                                    <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label">Waktu Mulai</label>
                                                            <input class="form-control" name="start" value="<?= date('Y-m-d\TH:i', strtotime($quiz['quiz_start']));?>" type="datetime-local" required>
                                                        </div>
                                                    </div> <!-- end col -->
                                                    ...
                                                    <div class="col-lg-6 mt-3 mt-lg-0">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="end" value="<?= date('Y-m-d\TH:i', strtotime($quiz['quiz_end']));?>" type="datetime-local" required>
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div>

...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Login Peserta | Ihsao</title>
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <?php if(isset($_COOKIE['error_login'])){
                                ...
                                <div class="alert alert-danger alert-dismissible bg-danger text-white border-0 fade show" role="alert">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        <?php if($_COOKIE['error_login']=='true'){ 
                                            echo "<strong>Login Gagal - </strong> Perika Kembali Email atau Nisn Anda";
                                        }elseif($_COOKIE['error_login']=='null'){ 
                                            echo "<strong>Error - </strong> Email dan Nisn Tidak Boleh Kosong";
                                        }?>
                                </div>
                                ...
                                <?php }} ?>
                                <form action="<?= base_url();?>peserta/auth" method="POST">
                                    <div class="mb-3">
                                        <label for="emailaddress" class="form-label">Email</label>
                                        <input class="form-control" type="email" id="emailaddress" name="email" placeholder="Masukkan alamat email anda">
                                    </div>
                                    <div class="mb-3">
                                        <label for="password" class="form-label">Nis</label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" id="text" class="form-control" name="nis" placeholder="Masukkan Nis anda">
                                        </div>
                                    </div>
